# Audible_Insight_Project
Audible Insights is a small recommendation-system project built from two Audible catalog CSV files.
The focus is on a reproducible data-cleaning pipeline, useful exploratory analysis, and recommendations that can be explained in a project review or viva.
